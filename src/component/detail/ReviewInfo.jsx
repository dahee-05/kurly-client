                ...
                <ul>
                    {
                        totalImages && totalImages.map((img, i)=>
                            (i  < 8 ) ? <li onClick={openTotalSlider} key={i}><img src={`http://localhost:9000/${img}`} alt="" /></li> :''
                        )
                    }
                                        ...
                                        <div className='thumb_list'>
                                            <ul>
                                                {item.images && item.images.map((img, idx)=>
                                                    <li onClick={() => openSlider(index)} key={idx}><img src={`http://localhost:9000/${img}`} alt="" /></li>
                                                )}
                                            </ul>
                                        </div>
                    ...
                    <div className="pop_slide">
                        ...
                        >
                            {slideImgs && slideImgs.map((img,i) =>
                                <SwiperSlide key={`${img}_${i}`}><a href='' target='_blank'><img src={`http://localhost:9000/${img}`} alt="" /></a></SwiperSlide>
                            )}
                        </Swiper>
                        {
                            (slideImgs.length !== 1) &&
